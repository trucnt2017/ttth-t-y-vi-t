...
@WebServlet("/LoadQuanLyKhoaHoc")
public class LoadQuanLyKhoaHoc extends HttpServlet {
	private static final long serialVersionUID = 1L;

    public LoadQuanLyKhoaHoc() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("QuanLyKhoaHoc.jsp").forward(request, response);
	}
